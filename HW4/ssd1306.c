...
void ssd1306_update() {
    ...
    i2c_write_blocking(i2c_default, SSD1306_ADDRESS, ssd1306_buffer, 513, false);
}
...
void ssd1306_clear() {
    memset(ssd1306_buffer, 0, sizeof(ssd1306_buffer)); // make every bit a 0, memset in string.h
